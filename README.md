...
```
git clone git@github.com:cftp/grunt-wp-plugin.git ~/.grunt-init/wp-plugin
```

### Windows Users

```
git clone git@github.com:cftp/grunt-wp-plugin.git %USERPROFILE%/.grunt-init/wp-plugin
```
